...
class A1 : virtual public Grand  //直接父类A1，虚继承
{
 public:
};
...
int main() {
    ...
    C c;
    //c.m_grand = 12; //直接父类不虚继承爷爷类--访问不明确，名字冲突，二义性；
...
/*
 * 查看分配
 *	cl /d1 reportSingleClassLayoutGrand 文件名.cpp  (注意没有看空格)
 *	cl /d1 reportSingleClassLayoutA1 文件名.cpp
 *	cl /d1 reportSingleClassLayoutC1 文件名.cpp
 *	
 */